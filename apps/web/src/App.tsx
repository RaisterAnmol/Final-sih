...
const ProtectedRoute: React.FC<{ children: React.ReactNode }> = ({
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F5F7FF] flex items-center justify-center text-indigo-600 font-mono text-sm">
        Loading Intelligence Station...
      </div>
    );
  }
  if (!user) {
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* Authenticated Platform Experience with full Sidebar & Navbar */}
            <Route
              element={
                <ProtectedRoute>
                  <AppLayout />
